            ...
            <div class="row">
                                ...
                                <li class="list-group-item border-0 px-0">
                                    <div class="form-check form-switch ps-0">
                                        ...
                                        <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0"
                                            for="flexSwitchCheckDefault">Envie-me um e-mail quando alguém me
                                            seguir</label>
                                    </div>
                                </li>
                                <li class="list-group-item border-0 px-0">
                                    <div class="form-check form-switch ps-0">
                                        ...
                                        <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0"
                                            for="flexSwitchCheckDefault1">Envie-me um e-mail quando alguém responder à
                                            minha postagem</label>
                                    </div>
                                </li>
                                <li class="list-group-item border-0 px-0">
                                    <div class="form-check form-switch ps-0">
                                        ...
                                        <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0"
                                            for="flexSwitchCheckDefault2">Envie-me um e-mail quando alguém me
                                            mencionar</label>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item border-0 px-0 pb-0">
                                    <div class="form-check form-switch ps-0">
                                        ...
                                        <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0"
                                            for="flexSwitchCheckDefault5">Assine o boletim informativo</label>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            <p class="text-sm">
                                Olá, sou Alec Thompson, Decisões: Se você não consegue decidir, a resposta é não. Se
                                houver dois caminhos igualmente difíceis, escolha aquele que for mais doloroso no curto
                                prazo (evitar a dor é criar uma ilusão de igualdade).</p>
                            <hr class="horizontal gray-light my-4">
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Nome
                                        completo:</strong> &nbsp; Alec M. Thompson</li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong
                                        class="text-dark">Telefone:</strong> &nbsp; (44) 123 1234 123</li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong
                                        class="text-dark">Email:</strong> &nbsp; alecthompson@mail.com</li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong
                                        class="text-dark">Localização:</strong> &nbsp; USA</li>
