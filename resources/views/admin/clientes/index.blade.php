...
<div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
        ...
        <a href="{{route('cliente.create')}}"><h6 class="font-weight-bolder mb-0">Novo</h6></a>
    </nav>
</div>
</nav>
<table class="table">
        ...
        <tbody class="table table-striped table-resposive">
            @foreach ($usuarios as $usuario)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('cliente.edit', ['usuario' => $usuario->id]) }}"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('cliente.excluir', ['usuario' => $usuario->id]) }}"
                                            method="POST">
